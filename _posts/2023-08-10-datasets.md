...
- [**GDW Database**](https://www.globaldamwatch.org/database) *`dam`*, *`shapefile`*
    - The Global Dam Watch (GDW) database integrates existing global datasets to support large-scale analyses. Version 1 of the GDW database contains 41,145 barrier locations and 35,295 associated reservoir polygons with a cumulative storage capacity of 7,405 km3  and an artificial terrestrial surface water area of 302,450 km2. ([Citation](https://www.nature.com/articles/s41597-024-03752-9)) A [table](https://www.globaldamwatch.org/directory) summrized the sources of the GDW database with links to each one of them.
